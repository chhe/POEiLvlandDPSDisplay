...
{
    StringReplace, ItemTypeName, ItemTypeName, Superior%A_Space%
    ItemListArray = 0
...
ParseItemType(ItemDataStats, ItemDataNamePlate, ByRef BaseType, ByRef SubType, ByRef GripType)
{
    ...
    Loop, Parse, ItemDataNamePlate, `n, `r
    {
        ...
        ; all armour types.
        If (InStr(A_LoopField, "Ringmail") AND (Not InStr(A_LoopField, "Gloves")) AND (Not InStr(A_LoopField, "Boots")))
        {
            BaseType = Armour
            SubType = BodyArmour
            return
...
ParseItemData(ItemData, ByRef RarityLevel="", ByRef NumPrefixes="", ByRef NumSuffixes="")
{
    ...
    IfInString, ItemDataPartsLast, Corrupted
    {
        IsCorrupted := True
    }
    ...
    TT := ItemName 
    If (ItemTypeName And Not ItemName = ItemTypeName)
    {
